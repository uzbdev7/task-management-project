...
import { getAllUsers, updateUser, getUserById, deleteUserById } from "../controller/user.controller.js";
...
import { UserUpdateSchema } from '../validations/auth.validation.js';
 ...
 router.put("/update/:id", validate(UserUpdateSchema,'body'), verifyToken, roleGuard('admin'), updateUser)
